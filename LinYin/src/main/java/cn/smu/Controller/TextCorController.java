...
public class TextCorController {
    ...
    @ResponseBody
    public OldNew TextCor1() throws Exception{//返回对比
    ...
    @PostMapping( "/upload")
    @ResponseBody
    public Object upload(@RequestParam("file") MultipartFile file) throws Exception{//上传原稿
    ...
    @PostMapping( "/totext")
    @ResponseBody
    public String totext() throws Exception{//返回原稿转换的文本
    ...
    @PostMapping( "/reptext")
    @ResponseBody
    public Report reptext() throws Exception {//对比的报告
