...
public class ApplicationTest {
    ...
    public void test3(){
       // User user=new User();
       // user.setUserid("111");
        //user.setUserpwd("textcor123");
       //userMapper.selectOne(new QueryWrapper<User>().eq("userid",user.getUserid()).eq("userpwd",user.getUserpwd()));
       //userService.resuser(user);
      // System.out.println(userService.loginuser(user));
        /*String string="{\"uid\":\"111\",\"password\":\"textcor123t\"}";
        ...
        //oldNew.setDtext(contrasttext);
        //System.out.println(oldNew);
       //System.out.println(textMapper.update(oldNew,new UpdateWrapper<OldNew>().set("ytext",oldNew.getYtext()).eq("id",1)));
       //System.out.println(textMapper.update(oldNew,new UpdateWrapper<OldNew>().set("dtext",oldNew.getDtext()).eq("id",1)));
        //oldNew=textMapper.selectById(1);
        //System.out.println(oldNew);
        //textService.setytext(str);
        //textService.setdtext(contrasttext);
        //oldNew=textService.sel();
        //oldandNew.dowork(oldNew.getYtext(),oldNew.getDtext());
        //textService.del();
        System.out.println(textService.sel());
        //System.out.println(textMapper.update(oldNew,new UpdateWrapper<OldNew>().set("ytext",null).set("dtext",null).eq("id",1)));
    }
